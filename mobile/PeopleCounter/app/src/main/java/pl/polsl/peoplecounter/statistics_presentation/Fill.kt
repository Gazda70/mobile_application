...
class Fill {
        ...
        when (type) {
            ...
            Type.LINEAR_GRADIENT -> {
                ...
                val gradient: LinearGradient = LinearGradient(
                    (if (gradientDirection == Direction.RIGHT) right else if (gradientDirection == Direction.LEFT) left else left).toInt().toFloat(),
                    (if (gradientDirection == Direction.UP) bottom else if (gradientDirection == Direction.DOWN) top else top).toInt().toFloat(),
    ...
    private val isClipPathSupported: Boolean = true
